    ...
    for (var i in points) {
      ...
      if (point.Latitude !== '' && point.Longitude !== '') {
        var marker = L.marker([point.Latitude, point.Longitude], {icon: icon})
          .bindPopup("<b><p>Title:" + point['ID Report Title'] + '</p></b><br>' + '<p>Date:</p>' + point['Report Date'] + '<br>' + '<p>Council Response:</p>' + point['Council Response'] + '<br>' + '<p>Response Date:</p>' + point['Response Date'] +
